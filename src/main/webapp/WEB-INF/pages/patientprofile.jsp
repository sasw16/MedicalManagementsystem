...
<body id="body-pd">
        ...
        <nav class="nav">
            <div>
                <div class="nav_list">
                    ...
                    <a href="patientprofile" class="nav_link active"> <i class='bx bx-user nav_icon'></i> <span
                            class="nav_name">My
                            Profile</span> </a>
                    <a href="editpatient" class=" nav_link"> <i class='bx bx-edit nav_icon'></i> <span
                            class="nav_name">Edit
                            Profile</span> </a>
                    <a href="doctorlist" class="nav_link"> <i class='bx bx-group nav_icon'></i> <span
                            class="nav_name">Doctors</span> </a>
                    <a href="addappointment" class="nav_link"> <i class='bx bx-calendar nav_icon'></i> <span
                            class="nav_name">Book
                            Appointment</span>
                    </a>
                </div>
    ...
    <div class="container row d-flex body-container text-center justify-content-md-center">
        ...
        <div class="card col-md-4 m-2 profile-card text-white">
            <div class="card-body mt-4">
                ...
                <div class="card-text mb-5">
                    <div class="mt-2">Gender: ${user.gender }</div>
                    <div class="mt-2">Age: 22</div>
                    <div class="mt-2">Email: ${user.email }</div>
                    <div class="mt-2">Phone: ${user.phone }</div>
                    <div class="mt-2">Address: ${user.address }</div>
                </div>
            </div>
        </div>
